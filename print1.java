...
public class print1 extends JFrame {
  ...
  protected void createUI() {
    ...
    file.add(new FilePrintAction1()).setAccelerator(
        KeyStroke.getKeyStroke(KeyEvent.VK_P, Event.CTRL_MASK));
    file.add(new FilePageSetupAction1()).setAccelerator(
        KeyStroke.getKeyStroke(KeyEvent.VK_P, Event.CTRL_MASK
            | Event.SHIFT_MASK));
    file.addSeparator();
    file.add(new FileQuitAction1()).setAccelerator(
        KeyStroke.getKeyStroke(KeyEvent.VK_Q, Event.CTRL_MASK));
    mb.add(file);
    setJMenuBar(mb);

    // Add the contents of the window.
    getContentPane().add(new PatchworkComponent1());
  ...
  public class FilePrintAction1 extends AbstractAction {
    public FilePrintAction1() {
      super("Print");
    }

    public void actionPerformed(ActionEvent ae) {
      PrinterJob pj = PrinterJob.getPrinterJob();
      ComponentPrintable1 cp = new ComponentPrintable1(getContentPane());
  ...
  public class FilePageSetupAction1 extends AbstractAction {
    public FilePageSetupAction1() {
      super("Page setup...");
    }
  ...
  public class FileQuitAction1 extends AbstractAction {
    public FileQuitAction1() {
      super("Quit");
    }
...
class PatchworkComponent1 extends JComponent implements Printable {
	JLabel jLabel;
	 JLabel jLabel1;
	 JLabel jLabel2;
	 JLabel jLabel3;
  ...
  public PatchworkComponent1(String s) {
    this();
   // mString = s;
  }
...
class ComponentPrintable1 implements Printable {
  private Component mComponent;

  public ComponentPrintable1(Component c) {
    mComponent = c;
  }
